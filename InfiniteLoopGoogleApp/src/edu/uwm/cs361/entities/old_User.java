...
public class old_User {
	...
	public old_User(int user_type, String username, String password, String firstName, String lastName, String email,
	...
	public old_User(Course[] student_courses, int user_type, String username, String password, String firstName, String lastName, String email,
			String phone_number) {
		this.user_type = user_type;
		this.username = username;
		this.password = password;
	...
	public old_User(int user_type, String username, String password, String firstName, String lastName, String email,
			String phone_number, Set<Course> student_courses) {
		this.user_type = user_type;
		this.username = username;
		this.password = password;
		this.firstName = firstName;
